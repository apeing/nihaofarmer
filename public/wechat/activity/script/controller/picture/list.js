...
(function(angular) {
    'use strict';
    angular.module('activity').controller('pictureListController', ['$scope', '$http', '$routeParams', '$window', '$qupload','$location','busyIndicatorService','alertMessageService','confirmMessageService', function($scope, $http, $routeParams, $window, $qupload,$location,busyIndicatorService,alertMessageService,confirmMessageService) {
